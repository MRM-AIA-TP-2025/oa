...
#include "sensors/msg/detail/navigation_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sensors::msg::NavigationData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sensors::msg::NavigationData & ros_message)
{
  // Member: distance
  cdr >> ros_message.distance;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensors::msg::NavigationData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sensors::msg::NavigationData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sensors::msg::NavigationData *>(
    untyped_ros_message);
...
{
  return &sensors::msg::typesupport_fastrtps_cpp::_NavigationData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensors, msg, NavigationData)() {
  return &sensors::msg::typesupport_fastrtps_cpp::_NavigationData__handle;
}
