...
#include "sensors/msg/detail/imu_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sensors::msg::ImuData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sensors::msg::ImuData & ros_message)
{
  // Member: acceleration
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensors::msg::ImuData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sensors::msg::ImuData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sensors::msg::ImuData *>(
    untyped_ros_message);
...
{
  return &sensors::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensors, msg, ImuData)() {
  return &sensors::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
