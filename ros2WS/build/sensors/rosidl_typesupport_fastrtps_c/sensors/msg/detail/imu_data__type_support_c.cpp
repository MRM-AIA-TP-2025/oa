...
#include "sensors/msg/detail/imu_data__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // acceleration, orientation

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_sensors
...
using _ImuData__ros_msg_type = sensors__msg__ImuData;
...
size_t get_serialized_size_sensors__msg__ImuData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ImuData__ros_msg_type * ros_message = static_cast<const _ImuData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ImuData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sensors__msg__ImuData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sensors
size_t max_serialized_size_sensors__msg__ImuData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensors__msg__ImuData;
    is_plain =
      (
...
static size_t _ImuData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sensors__msg__ImuData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sensors, msg, ImuData)() {
