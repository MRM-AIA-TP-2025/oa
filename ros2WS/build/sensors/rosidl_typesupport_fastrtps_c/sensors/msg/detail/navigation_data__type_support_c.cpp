...
#include "sensors/msg/detail/navigation_data__rosidl_typesupport_fastrtps_c.h"
...
using _NavigationData__ros_msg_type = sensors__msg__NavigationData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: isonline
  {
    cdr << (ros_message->isonline ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: isonline
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->isonline = tmp ? true : false;
  }
...
size_t get_serialized_size_sensors__msg__NavigationData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name isonline
  {
    size_t item_size = sizeof(ros_message->isonline);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _NavigationData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sensors__msg__NavigationData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sensors
size_t max_serialized_size_sensors__msg__NavigationData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sensors__msg__NavigationData;
    is_plain =
      (
      offsetof(DataType, isonline) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _NavigationData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sensors__msg__NavigationData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sensors, msg, NavigationData)() {
