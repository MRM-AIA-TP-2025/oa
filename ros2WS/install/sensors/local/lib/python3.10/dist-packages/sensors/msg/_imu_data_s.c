...
bool sensors__msg__imu_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sensors.msg._imu_data.ImuData", full_classname_dest, 29) == 0);
  }
  sensors__msg__ImuData * ros_message = _ros_message;
  {  // acceleration
  ...
  {  // orientation
    ...
    if (!geometry_msgs__msg__vector3__convert_from_py(field, &ros_message->orientation)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * sensors__msg__imu_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sensors.msg._imu_data");
  ...
  {  // orientation
    PyObject * field = NULL;
    field = geometry_msgs__msg__vector3__convert_to_py(&ros_message->orientation);
    if (!field) {
      return NULL;
    }
    {
