...
{
  new (message_memory) sensors::msg::ImuData(_init);
}

void ImuData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sensors::msg::ImuData *>(message_memory);
  typed_message->~ImuData();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ImuData_message_member_array[2] = {
  {
    "acceleration",  // name
    ...
    offsetof(sensors::msg::ImuData, acceleration),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensors::msg::ImuData, orientation),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<sensors::msg::ImuData>()
{
  return &::sensors::msg::rosidl_typesupport_introspection_cpp::ImuData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensors, msg, ImuData)() {
  return &::sensors::msg::rosidl_typesupport_introspection_cpp::ImuData_message_type_support_handle;
}
