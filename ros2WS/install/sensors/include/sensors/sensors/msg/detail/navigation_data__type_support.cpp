...
{
  new (message_memory) sensors::msg::NavigationData(_init);
}

void NavigationData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sensors::msg::NavigationData *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NavigationData_message_member_array[4] = {
  {
    ...
    offsetof(sensors::msg::NavigationData, distance),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensors::msg::NavigationData, bearing),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensors::msg::NavigationData, orientation),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sensors::msg::NavigationData, isonline),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers NavigationData_message_members = {
  ...
  4,  // number of fields
  sizeof(sensors::msg::NavigationData),
...
{
  return &::sensors::msg::rosidl_typesupport_introspection_cpp::NavigationData_message_type_support_handle;
}
